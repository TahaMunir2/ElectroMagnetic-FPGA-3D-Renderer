# Design 1 S32 PYNQ-Z1 HDMI Output
...
```tcl
source scripts/create_d1s32_vivado_project.tcl
```
...
The generated project is `D1S32/vivado_project_d1s32/d1s32_renderer.xpr`.
...
That project is `D1S32/vivado_project_d1s32_camera/d1s32_camera_renderer.xpr`.
...
2. Add these HDL files to Design Sources:
   - `D1S32/D1_wrapper/design1_ray_unit_hdmi_top.sv`
   - `D1S32/D1_wrapper/design1_video_timing_640x480.sv`
   - `D1S32/D1_wrapper/cube_heightmap_bram.sv`
   - `D1S32/design1_*.sv`
3. Add `D1S32/D1_wrapper/pynq_z1_hdmi.xdc` to Constraints.
...
The Design 1 S32 renderer latency is assumed to be 142 pixel-clock cycles. `design1_ray_unit_hdmi_top`
