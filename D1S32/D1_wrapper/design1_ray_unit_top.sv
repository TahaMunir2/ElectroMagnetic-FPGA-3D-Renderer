...
//    - 36 inferred block RAMs (32 marcher + 4 normal)
//    - a free-running pixel counter driving valid_in/px/py
//    - hardcoded (but non-trivial) camera parameters
//
//  GRID_N is reduced to 64 (from 256) so the 32-step build fits on an
...
module design1_ray_unit_top (
    ...
    localparam int GRID_N  = 64;   // keep â‰?4 on Artix-7 / Zynq-7020
    ...
    // low enough that the current 32-step marcher reaches the terrain.
