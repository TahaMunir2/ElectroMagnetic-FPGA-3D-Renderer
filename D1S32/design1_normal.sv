...
//  for altitude colouring â€?at zero BRAM cost compared to the previous
...
//               addresses.
//      Stage 2: BRAM is reading â€?carry payload + xf/yf forward.
//      Stage 3: BRAM data valid â€?latch h00, h10, h01, h11.
...
module design1_normal #(
    ...
    always_comb begin
        ...
        // h00 + (prod >>> FRAC_W) â€?narrow to H_W with arithmetic shift
