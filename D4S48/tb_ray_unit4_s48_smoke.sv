// Smoke test for D4S48 using the HDMI wrapper camera and mock heightmap.
// It also checks that the renderer's output coordinates remain aligned.

`timescale 1ns/1ps

module tb_ray_unit4_s48_smoke;
    ...
    initial begin
        ...
        $display("D4S48_SMOKE samples=%0d outputs=%0d sky=%0d non_sky=%0d coord_errors=%0d",
