// Smoke test for Design2 ray_unit2 with the same camera used by HDMI top.
// It samples the frame on an 8-pixel grid and fails if all outputs are sky.

`timescale 1ns/1ps

module tb_ray_unit2_smoke;
