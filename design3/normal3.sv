// ============================================================================
//  normal3.sv  (Design 3: simplified normal, 2 BRAM ports / 1 copy)
//  ----------------------------------------------------------------------------
//  In Design 3 the marcher already produces a bilinearly-interpolated surface
...
//  muxing trivial and symmetric with normal2.
//
