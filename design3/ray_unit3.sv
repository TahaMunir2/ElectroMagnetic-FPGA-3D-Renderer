// ============================================================================
//  ray_unit3.sv  (Design 3 top-level single-pixel renderer)
//  ----------------------------------------------------------------------------
//  Chains ray_gen -> marcher3 -> normal3 -> shader.
//
//  Design 3: bilinear interpolation INSIDE the marcher (smooth silhouettes),
...
module ray_unit3 #(
    ...
    // ----- Marcher BRAM ports: 2 per step, NOT shared -----
    output logic [IDX_W*2-1:0]         marcher_bram_addr [N_STEPS][2],
    output logic                       marcher_bram_re   [N_STEPS][2],
    input  logic signed [H_W-1:0]      marcher_bram_dout [N_STEPS][2],
