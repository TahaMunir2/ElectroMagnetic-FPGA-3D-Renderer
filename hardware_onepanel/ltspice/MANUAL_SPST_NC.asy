...
CIRCLE Normal 4 -4 12 4
TEXT -28 24 Left 1 NC
WINDOW 0 -32 -48 Left 2
WINDOW 3 -32 40 Left 2
SYMATTR Prefix X
SYMATTR Value MANUAL_SPST_NC
SYMATTR SpiceLine STATE=0
SYMATTR ModelFile ManualSwitch.lib
SYMATTR Description Manual SPST normally-closed switch. STATE=0 closed, STATE=1 open.
PIN -64 0 LEFT 8
PINATTR PinName a
