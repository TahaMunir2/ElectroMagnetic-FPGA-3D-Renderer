# Build the package-generated Vivado project through bitstream generation.
#
# Usage:
...
set project_path [file normalize [file join $pkg_dir vivado_project_d4s48_lowdsp d4s48_lowdsp_renderer.xpr]]
set jobs 8
set reports_dir ""
...
catch {report_bus_skew -warn_on_violation -file [file join $reports_dir bus_skew.rpt]}
