# Create a PYNQ-Z1 block-design Vivado project for D1S32 with PS camera control.
#
# Usage from the repo root:
#   vivado -mode batch -source scripts/create_d1s32_camera_bd_project.tcl
#
# To recreate:
#   vivado -mode batch -source scripts/create_d1s32_camera_bd_project.tcl -tclargs -force
#
# To create in a different output directory:
#   vivado -mode batch -source scripts/create_d1s32_camera_bd_project.tcl -tclargs -project_dir D:/tmp/d1s32_camera
#
# Output project:
#   D1S32/vivado_project_d1s32_camera/d1s32_camera_renderer.xpr

set repo_dir [file normalize [file join [file dirname [info script]] ..]]
set project_name d1s32_camera_renderer
set project_dir [file normalize [file join $repo_dir D1S32 vivado_project_d1s32_camera]]
...
foreach rel_path {
    D1S32/D1_wrapper/design1_video_timing_640x480.sv
    D1S32/D1_wrapper/cube_heightmap_bram.sv
    D1S32/D1_wrapper/camera_ctrl_axi.sv
    D1S32/D1_wrapper/d1s32_renderer_core_axi.sv
    D1S32/D1_wrapper/d1s32_renderer_core_axi_bd.v
    D1S32/design1_ray_gen.sv
    D1S32/design1_march_step.sv
    D1S32/design1_marcher.sv
    D1S32/design1_normal.sv
    D1S32/design1_shader.sv
    D1S32/design1_ray_unit.sv
} {
...
set renderer [create_bd_cell -type module -reference d1s32_renderer_core_axi_bd d1s32_renderer_core_axi_0]
...
connect_bd_net [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins d1s32_renderer_core_axi_0/s_axi_aresetn]
connect_bd_net [get_bd_pins ps7_0/FCLK_CLK0] [get_bd_pins d1s32_renderer_core_axi_0/s_axi_aclk]

apply_bd_automation -rule xilinx.com:bd_rule:axi4 \
    -config {Master "/ps7_0/M_AXI_GP0" Clk_master "/ps7_0/FCLK_CLK0" Clk_slave "/ps7_0/FCLK_CLK0" Clk_xbar "/ps7_0/FCLK_CLK0"} \
    [get_bd_intf_pins d1s32_renderer_core_axi_0/S_AXI]
...
connect_bd_net [get_bd_pins rst_pixel_25M/peripheral_aresetn] [get_bd_pins d1s32_renderer_core_axi_0/rst_pix_n]
connect_bd_net [get_bd_pins rst_pixel_25M/peripheral_reset] [get_bd_pins rgb2dvi_0/aRst]

connect_bd_net [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins d1s32_renderer_core_axi_0/clk_pix]
...
connect_bd_net [get_bd_pins d1s32_renderer_core_axi_0/vid_pData]  [get_bd_pins rgb2dvi_0/vid_pData]
connect_bd_net [get_bd_pins d1s32_renderer_core_axi_0/vid_pVDE]   [get_bd_pins rgb2dvi_0/vid_pVDE]
connect_bd_net [get_bd_pins d1s32_renderer_core_axi_0/vid_pHSync] [get_bd_pins rgb2dvi_0/vid_pHSync]
connect_bd_net [get_bd_pins d1s32_renderer_core_axi_0/vid_pVSync] [get_bd_pins rgb2dvi_0/vid_pVSync]
...
assign_bd_address
set renderer_segs [get_bd_addr_segs -quiet ps7_0/Data/*d1s32_renderer_core_axi_0*]
...
puts ""
puts "Created D1S32 camera-control Vivado project:"
