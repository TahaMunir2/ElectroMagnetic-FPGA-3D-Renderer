# Create a standalone Vivado project for the D1S48 HDMI renderer.
#
# Usage from the repo root:
#   vivado -mode batch -source scripts/create_d1s48_vivado_project.tcl
#
# To recreate an existing generated project:
#   vivado -mode batch -source scripts/create_d1s48_vivado_project.tcl -tclargs -force
#
# If the Digilent rgb2dvi IP is in a nonstandard location:
#   vivado -mode batch -source scripts/create_d1s48_vivado_project.tcl -tclargs -force -ip_repo D:/path/to/vivado-library/ip
#
# Output project:
#   D1S48/vivado_project_d1s48/d1s48_renderer.xpr

set repo_dir [file normalize [file join [file dirname [info script]] ..]]
set project_name d1s48_renderer
set project_dir [file normalize [file join $repo_dir D1S48 vivado_project_d1s48]]
...
# Register Digilent Vivado IP library if present. The D1S48 HDMI top needs the
...
set source_files [list \
    ...
    [checked_file [file join $repo_dir D1S48 design1_normal.sv]] \
    [checked_file [file join $repo_dir D1S48 design1_shader.sv]] \
    [checked_file [file join $repo_dir D1S48 design1_ray_unit.sv]] \
]
...
puts ""
puts "Created D1S48 Vivado project:"
