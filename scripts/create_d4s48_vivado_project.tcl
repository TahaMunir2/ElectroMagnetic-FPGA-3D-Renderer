# Create a standalone Vivado project for the 48-step Design4 HDMI renderer.
#
...
set project_name d4s48_renderer
set project_dir [file normalize [file join $repo_dir D4S48 vivado_project_d4s48]]
...
set source_files [list \
    [checked_file [file join $repo_dir D4S48 ray_unit_hdmi_top_d4s48.sv]] \
    ...
    [checked_file [file join $repo_dir D4S48 marcher4.sv]] \
    [checked_file [file join $repo_dir D4S48 normal4.sv]] \
    [checked_file [file join $repo_dir D4S48 shader.sv]] \
    [checked_file [file join $repo_dir D4S48 ray_unit4.sv]] \
]
...
# PYNQ-Z1 PL clock is 125 MHz. D4S48 needs 25 MHz scanout, 125 MHz TMDS
...
puts ""
puts "Created D4S48 Vivado project:"
