# Create a standalone Vivado project for the Design2 HDMI renderer.
#
# Usage from the repo root:
#   vivado -mode batch -source scripts/create_design2_vivado_project.tcl
#
# To recreate an existing generated project:
#   vivado -mode batch -source scripts/create_design2_vivado_project.tcl -tclargs -force
#
# To build in a different generated project directory:
#   vivado -mode batch -source scripts/create_design2_vivado_project.tcl -tclargs -force -project_dir design2/vivado_project_design2_checked
#
# If the Digilent rgb2dvi IP is in a nonstandard location:
#   vivado -mode batch -source scripts/create_design2_vivado_project.tcl -tclargs -force -ip_repo D:/path/to/vivado-library/ip
#
# Output project:
#   design2/vivado_project_design2/design2_renderer.xpr

set repo_dir [file normalize [file join [file dirname [info script]] ..]]
set project_name design2_renderer
set project_dir [file normalize [file join $repo_dir design2 vivado_project_design2]]
set part_name xc7z020clg400-1
set top_name ray_unit_hdmi_top_d2
set force_project 0
...
# Register Digilent Vivado IP library if present. The HDMI top needs rgb2dvi,
# which is not included in the standard Xilinx catalog.
...
set source_files [list \
    [checked_file [file join $repo_dir design2 ray_unit_hdmi_top_d2.sv]] \
    [checked_file [file join $repo_dir wrapper video_timing_640x480.sv]] \
    [checked_file [file join $repo_dir wrapper heightmap_bram.sv]] \
    [checked_file [file join $repo_dir design2 ray_gen.sv]] \
    [checked_file [file join $repo_dir design2 march_step2.sv]] \
    [checked_file [file join $repo_dir design2 marcher2.sv]] \
    [checked_file [file join $repo_dir design2 normal2.sv]] \
    [checked_file [file join $repo_dir design2 shader.sv]] \
    [checked_file [file join $repo_dir design2 ray_unit2.sv]] \
]
...
# Clock wizard: PYNQ-Z1 PL clock is 125 MHz. Design2 needs 25 MHz scanout,
# 125 MHz TMDS serial, and a 50 MHz render/core clock.
...
puts ""
puts "Created Design2 Vivado project:"
