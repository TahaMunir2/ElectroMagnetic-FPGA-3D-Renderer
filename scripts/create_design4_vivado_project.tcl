# Create a standalone Vivado project for the Design4 HDMI renderer.
#
...
set project_name design4_renderer
set project_dir [file normalize [file join $repo_dir design4 vivado_project_design4]]
set part_name xc7z020clg400-1
set top_name ray_unit_hdmi_top_d4
set force_project 0
...
# Register the Digilent Vivado IP library if present. rgb2dvi is not included
# in the standard Xilinx catalog.
...
set source_files [list \
    [checked_file [file join $repo_dir design4 ray_unit_hdmi_top_d4.sv]] \
    [checked_file [file join $repo_dir wrapper video_timing_640x480.sv]] \
    [checked_file [file join $repo_dir wrapper heightmap_bram.sv]] \
    [checked_file [file join $repo_dir design4 ray_gen.sv]] \
    [checked_file [file join $repo_dir design4 march_step4.sv]] \
    [checked_file [file join $repo_dir design4 marcher4.sv]] \
    [checked_file [file join $repo_dir design4 normal4.sv]] \
    [checked_file [file join $repo_dir design4 shader.sv]] \
    [checked_file [file join $repo_dir design4 ray_unit4.sv]] \
]
...
# PYNQ-Z1 PL clock is 125 MHz. Design4 needs 25 MHz scanout, 125 MHz TMDS
# serial, and a 100 MHz quarter-rate renderer core clock.
...
puts ""
puts "Created Design4 Vivado project:"
