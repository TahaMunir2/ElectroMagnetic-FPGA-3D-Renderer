// ============================================================================
//  ray_unit4.sv  (D4S80DO top-level single-pixel renderer)
//  ----------------------------------------------------------------------------
...
//
//  BRAM ports exposed:
//      marcher4 : N_STEPS * 1 = 80 ports  (flat unpacked array [N_STEPS])
//      normal4  : 2 ports
//      Total heightmap memories: 80 marcher + 2 normal.
//
//  Pipeline latency (D4S80DO):
//      ray_gen  :   4 cycles
//      marcher4 : 960 cycles (80 march_step4 * 12-cycle latency)
//      normal4  :   5 cycles
//      shader   :   5 cycles
//      TOTAL    : 974 cycles
//
