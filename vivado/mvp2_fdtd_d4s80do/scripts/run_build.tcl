...
open_project [file join $proj_dir MVP2_fdtd_d4s80do.xpr]
...
set bit [file join $proj_dir MVP2_fdtd_d4s80do.runs impl_1 fdtd_hdmi_bd_wrapper.bit]
if {[file exists $bit]} {
...
set hwh [file join $proj_dir MVP2_fdtd_d4s80do.gen sources_1 bd fdtd_hdmi_bd hw_handoff fdtd_hdmi_bd.hwh]
if {[file exists $hwh]} {
