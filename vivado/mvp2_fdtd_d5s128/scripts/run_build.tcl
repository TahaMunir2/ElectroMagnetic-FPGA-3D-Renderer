...
open_project [file join $proj_dir MVP2_fdtd_d5s128.xpr]
...
set bit [file join $proj_dir MVP2_fdtd_d5s128.runs impl_1 fdtd_hdmi_bd_wrapper.bit]
if {[file exists $bit]} {
...
set hwh [file join $proj_dir MVP2_fdtd_d5s128.gen sources_1 bd fdtd_hdmi_bd hw_handoff fdtd_hdmi_bd.hwh]
if {[file exists $hwh]} {
