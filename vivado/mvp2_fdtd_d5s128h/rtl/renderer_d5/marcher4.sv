...
//
//      N_STEPS * 1 logical read port (= 128 for N_STEPS=128)
//      -> D5 pairs them into 64 independent dual-read heightmap memories
//
...
module marcher4 #(
    ...
    parameter logic signed [POS_W-1:0] DT         = WORLD_HALF / GRID_N
)(
    input  logic                       clk,
    input  logic                       rst_n,
    input  logic                       en,
