...
#  D5S128H low-DSP ray-march renderer out over HDMI, all PS-controllable.
#
...
set proj_name  "MVP2_fdtd_d5s128h"
...
# Renderer sources (D5S128H 3D ray-march: module-ref d5s128h_renderer_core_bd +
# paired dual-read 8-bit heightmap copies, low-DSP ray_unit4 pipeline)
set rend_files [list \
    [file join $rtl_dir renderer_d5 d5s128h_renderer_core_bd.v]       \
    [file join $rtl_dir renderer_d5 d5s128h_core_impl.sv]             \
    [file join $rtl_dir renderer_d5 ray_unit4.sv]                     \
    [file join $rtl_dir renderer_d5 marcher4.sv]                      \
    [file join $rtl_dir renderer_d5 march_step4.sv]                   \
    [file join $rtl_dir renderer_d5 normal4.sv]                       \
    [file join $rtl_dir renderer_d5 ray_gen.sv]                       \
    [file join $rtl_dir renderer_d5 shader.sv]                        \
    [file join $rtl_dir renderer_d5 heightmap_bram_d5_dualread.sv]    \
...
# ---- clk_wiz: 125 -> 25 (pixel) + 125 (serial) + 100 (D5S128H render core) ----
...
# ---------------------------------------------------------------------------
create_bd_cell -type module -reference d5s128h_renderer_core_bd renderer_0
...
# (D5S128H: render core @100MHz, async-FIFO to 25MHz scanout; PS-loadable camera)
