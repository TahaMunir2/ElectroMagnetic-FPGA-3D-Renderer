...
Use `ray_unit_hdmi_top.sv` for board output on the PYNQ-Z1 HDMI TX connector.
...
The renderer latency is assumed to be 77 pixel-clock cycles. `ray_unit_hdmi_top`
